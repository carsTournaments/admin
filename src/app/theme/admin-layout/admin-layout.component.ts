...
import { AppDirectionality } from '@services/various/directionality.service';
import { AppSettings } from '@services/api/settings/settings';
...
export class AdminLayoutComponent implements OnDestroy {
    ...
    constructor(
        ...
        if (
            this.mediaMatcher.matchMedia('(prefers-color-scheme)').media !==
            'not all'
        ) {
