export class CustomTableViewModel {
    ...
    tableHeadItems: any = {
        ...
        car: [
            ...
            { name: 'Likes', order: 'likes', col: null },
        ...
        notification: [
            { name: 'Titulo', order: 'title', col: null },
            { name: 'Link', order: 'link', col: null },
            { name: 'Alcance', order: null, col: null },
            { name: 'Visto', order: 'opened', col: null },
            { name: 'Creado', order: 'created', col: null },
        ],
        pairing: [
        ...
        tournament: [
            ...
            { name: 'Pairings', order: 'pairings', col: null },
            { name: 'Votos', order: 'votes', col: null },
